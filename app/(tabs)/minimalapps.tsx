...
export default function MinimalApps() {
		...
		<SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#071615' : '#fff' }]}>
			<Animated.View style={[styles.container, { transform: [{ translateX: slideAnim }] }]}>
				<View style={styles.center}>
					<Text style={[styles.title, { color: isDark ? '#fff' : '#0A1E1C' }]}>Welcome to Minimal Apps</Text>
					<Text style={[styles.subtitle, { color: isDark ? '#cfeee8' : '#4A6563' }]}>A minimal placeholder screen for the Minimal Apps module.</Text>
				</View>
			</Animated.View>
		</SafeAreaView>
	);
